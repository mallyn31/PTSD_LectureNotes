...
/* 
    If Statements: gives a yes/true response response if the expression is true/valid
...
// String Interpolation: using a variable in a string with backticks `, dollar sign $ and curly braces {}
let myName = "Kate";
let bff = "Ben";
console.log(`My name is ${myName} and my best friend is${bff}!`); //interpolation happens with use of ` backticks` and ${}
console.log("My name is ${myName} and my best friend is${bff}!") // just a normal string
